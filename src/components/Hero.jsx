      ...
      <div className="flex justify-center items-center   p-10 ">
        ...
        <div className=" flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex items-center gap-10 ">
            <div className=" px-5 py-2 bg-black rounded ">
              <button className="text-white text-lg flex items-center gap-2 justify-center font-medium font-['Clash Display'] capitalize leading-7">
                get start <IoIosArrowRoundForward size={25} />
              </button>
            </div>
            <div className="px-5 py-2  ">
              <button className="text-lg flex items-center gap-2 justify-center font-medium font-['Clash Display'] capitalize leading-7">
                {" "}
        ...
        <div className=" w-1/2 ">
          ...
          <div className="absolute right-[4px] top-24  ">
